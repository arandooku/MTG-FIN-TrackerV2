...
function VariantChips({
  ...
  const legendLabels: Record<VdotKind, string> = {
    regular: 'Regular',
    foil: 'Foil',
    ext: 'Extended Art',
    'ext-foil': 'Ext Foil',
...
// Suppress unused import warning by keeping CardImage available for re-export consumers
export { CardImage };
